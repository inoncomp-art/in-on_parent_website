...
export default function About() {
  return <main>
    ...
    <section className="editorial-hero about-hero">
      <div className="about-video" aria-hidden="true"><iframe src="https://player.vimeo.com/video/1105429708?background=1&autoplay=1&muted=1&loop=1&title=0&byline=0&portrait=0" title="Skincare ritual background video" tabIndex={-1} /></div>
